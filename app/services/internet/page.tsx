		...
		<div className="min-h-screen bg-white font-sans">
			...
			<header className="border-b border-[#E5E7EB] py-4 px-6">
				<div className="max-w-7xl mx-auto flex items-center">
					<Link
						href="/"
						className="flex items-center text-[#1E293B] mr-4"
					>
			...
			<main className="max-w-xl mx-auto px-6 py-8">
				<div className="flex flex-col items-center mb-6">
					{/* Service icon */}
					<div className="bg-[#F1F5F9] rounded-full w-16 h-16 flex items-center justify-center mb-2">
				...
				{/* Service label */}
				<span className="text-[#16A34A] text-sm font-medium tracking-wider uppercase">
					Internet
				</span>
				...
				<p className="service-description mb-8">
					Set up your internet today to avoid any interruptions once
					you move in.
				</p>
			...
			{/* Footer */}
			<footer className="fixed bottom-0 left-0 right-0 border-t border-[#E5E7EB] bg-white py-4 px-6">
