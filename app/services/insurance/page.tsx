...
import { getBrandingFromCookie, getUserIdFromSession } from '@/lib/session';
					...
					<main className="w-full max-w-[375px] mx-auto flex flex-col items-center pt-[58px] pb-10 px-6">
						...
						<div className="flex flex-col items-center gap-6 w-full">
							...
							<div className="w-[327px] flex flex-col items-start gap-2">
								<div className="text-primary text-[14px] font-semibold uppercase leading-[14px] tracking-[0.28px] font-poppins">
									Renter insurance program
								</div>
								<div className="text-[#090949] text-[28px] font-semibold leading-[36.4px] font-poppins">
									You’re covered!
								</div>
								<div className="text-[#5C5C75] text-base font-normal leading-6 font-poppins">
									Our policy covers your home and your
						...
						<div className="w-[327px] bg-[#F7F7FB] rounded-[24px] flex flex-col gap-6 p-5 mb-6">
							<div className="flex flex-col gap-2">
								<div className="text-[#090949] text-xl font-semibold leading-[26px] font-poppins">
									Policy basics
								</div>
							</div>
							<div className="flex flex-col gap-2">
								<div className="text-[#090949] text-lg font-semibold leading-[20.8px] font-poppins">
									Insurance details
								</div>
								<div>
									<span className="text-[#090949] text-xs font-semibold leading-[18px] font-poppins">
										Policy #:
									</span>
						...
						<div className="w-[327px] bg-white border border-[#E8E8F1] rounded-[24px] flex flex-col gap-4 p-5 mb-6 shadow-sm">
							<div className="text-[#090949] text-lg font-semibold leading-6 font-poppins">
								Want to bring your own insurance?
							</div>
							<div className="text-[#5C5C75] text-base font-normal leading-6 font-poppins">
								If you prefer to use your own renters insurance
								policy, you can decline our standard coverage
								and submit your policy for approval. Make sure
								your policy meets all lease requirements.
							</div>
							<Link
						...
						<div className="w-[327px] flex flex-col gap-6 mb-6">
							...
							<div className="flex flex-col items-center gap-2">
								...
								<div className="text-[#5C5C75] text-base font-normal leading-6 font-poppins">
									You can submit your claim through the form
									at{' '}
									<Link
						...
						<div className="w-[330px] flex flex-col items-center gap-4 pb-10">
							<div className="flex justify-center items-center gap-1">
								<span className="text-[#5C5C75] text-[10px] font-normal leading-[15px] font-poppins">
									Powered by{' '}
								</span>
								<span className="text-[#5C5C75] text-[10px] font-semibold leading-[15px] font-poppins">
									Second Nature
								</span>
							</div>
						</div>
